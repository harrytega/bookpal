...
// BookInMyDb book in my db
//
// swagger:model bookInMyDb
type BookInMyDb struct {
...
// Validate validates this book in my db
func (m *BookInMyDb) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BookInMyDb) validateAuthor(formats strfmt.Registry) error {
...
func (m *BookInMyDb) validateBookID(formats strfmt.Registry) error {
...
func (m *BookInMyDb) validateTitle(formats strfmt.Registry) error {
...
// ContextValidate validates this book in my db based on context it is used
func (m *BookInMyDb) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *BookInMyDb) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BookInMyDb) UnmarshalBinary(b []byte) error {
	var res BookInMyDb
