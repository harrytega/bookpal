...
// NewChangeListNameParams creates a new ChangeListNameParams object
// no default values defined in spec.
func NewChangeListNameParams() ChangeListNameParams {

	return ChangeListNameParams{}
}

// ChangeListNameParams contains all the bound params for the change list name operation
// typically these are obtained from a http.Request
//
// swagger:parameters changeListName
type ChangeListNameParams struct {
	...
	*/
	...
	/*updated List with a new name.
	  ...
	  In: body
	*/
	UpdatedList *types.ListRequest
}

// BindRequest both binds and validates a request, it assumes that complex things implement a Validatable(strfmt.Registry) error interface
// for simple values it will use straight method calls.
//
// To ensure default values, the struct must have been initialized with NewChangeListNameParams() beforehand.
func (o *ChangeListNameParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ChangeListNameParams) bindListID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *ChangeListNameParams) validateListID(formats strfmt.Registry) error {
